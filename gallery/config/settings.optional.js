...
pmgConfig.theme = 'custom'; // Theme values: 'redPMG', 'bluePMG', 'greenPMG', 'custom'. Default: 'redPMG'.

// DEFAULT LAYOUT MODE. values: 'grid' or 'list' or 'slide'. Default: 'grid'.
...
// ADDRESS LOCATOR URL
pmgConfig.locatorURL = 'http://maps.indiana.edu/ArcGIS/rest/services/Utilities/Locator_IN_Composite/GeocodeServer';

// GEOMETRY URL  /* New */ 
// ESRI specific
// pmgConfig.geometryURL = 'http://tasks.arcgisonline.com/ArcGIS/rest/services/Geometry/GeometryServer';
// Local URL
pmgConfig.geometryURL = 'http://maps.indiana.edu/ArcGIS/rest/services/Utilities/Geometry/GeometryServer';
